...
<html>
	...
	<head lang="en">
		...
		<!-- <link id="bootstrap-style" href="/h/css/bootstrap.min.css" rel="stylesheet"> -->
	  ...
	  <div class="login-banner">
	    <div class="login-main">
	      ...
	      <div class="login-box">
	        ...
	        <form method="post" action="/home/login/dologin">
		        ...
		        <div class="login-form">
		            ...
		            <div class="user-name">
		              ...
		              <input type="text" name="uname" id="user" placeholder="邮箱/手机/用户名"></div>
		            <div class="user-pass">
		              <label for="password">
		                <i class="am-icon-lock"></i>
		              </label>
		              <input type="password" name="pass" id="password" placeholder="请输入密码"></div>
		         ...
		         @if(session('success'))
						...
						@endif
						@if(session('error'))
							<div class='alert alert-error' style="font-size: 14px;color: white;background: #FD7A72;width: 320px;height: 41px;text-align: center;line-height: 40px;margin-top:10px">
								用户名或密码错误
							</div>
						@endif
	        ...
	        <li><a href="#"><i class="am-icon-weixin am-icon-sm"></i><span>微信登录</span> </a></li></div>
	        </div>	 -->
	      </div>
	    </div>
	  </div>
