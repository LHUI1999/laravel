							...
							<div class="cart-table-th">
								<div class="wp">
									...
									<div class="th th-item">
										<div class="td-inner"style='float:left;margin-left:137px;margin-top:26px;'>商品信息</div>
									</div>
									<div class="th th-price" style='float:left;margin-left:359px;margin-top:26px;'>
										<div class="td-inner">单价</div>
									</div>
									<div class="th th-amount"style='float:left;margin-left:666px;margin-top:-20px;'>
										<div class="td-inner">数量</div>
									</div>
									<div class="th th-sum"style='float:left;margin-left:769px;margin-top:-20px;'>
										<div class="td-inner">金额</div>
									</div>
									<div class="th th-oplist"style='float:left;margin-left:860px;margin-top:-20px;'>
					...
					<li class="td td-item">
						<div class="item-pic">
							<a href="#" class="J_MakePoint">
								<img src="/h/images/kouhong.jpg_80x80.jpg" style="width:80px;height:80px;" class="itempic J_ItemImg"></a>
						</div>
						<div class="item-info">
						...
						<!--留言-->
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计（含运费） <span>¥</span><em class="pay-sum">{{ $v->xiaoji }}</em>
								</p>
							</div>
