					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
                            ...
                            <div class="tb-booth tb-pic tb-s310">
								<a href="/h/images/01.jpg"><img src="/uploads/{{ $goodspic[0]->pic  }}" alt="细节展示放大镜特效" rel="/uploads/{{ $goodspic[0]->pic  }}" class="jqzoom" /></a>
                            </div>
							...
							<ul style="float:left;" class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
                                        <a href="#">
                                            <img src="/uploads/{{ $vv->pic  }}" mid="/uploads/{{ $goodspic[0]->pic  }}" big="/uploads/{{ $goodspic[0]->pic  }}">
                                        </a>
									</div>
								</li>
...
<dl class="iteminfo_parameter freight">
    ...
    <div style="float:left;margin-left:1px;">
        ...
        由 <span style="color:#E4393C;font-size:12px;">悦桔拉拉</span>  发货, 并提供售后服务.今天 <?php echo date('h:i:s', time()) ?>前下单，预计
        <span style="font-size:13px;font-weight:bold;"><?php echo date('Y-m-d',strtotime('+3 day')) ?></span>日送达
            ...
            <div class="theme-signin-left">	
                <div class="theme-options">
                    ...
                    <dd>
                        ...
                        <span id="Stock" class="tb-hidden">库存<span class="stock">{{ $v->num }}</span>件</span>
                    </dd>
    ...
    <div class="pay">
        ...
        <li>
            <div class="clearfix tb-btn tb-btn-basket theme-login">
                <a id="LikBasket" title="加入购物车" href="/home/car/add?id={{ $v->id }}"><i></i>加入购物车</a>
            </div>
        </li>
    </div>
    <div>
        <div>
            <span style='float:left;margin-left:-422px;margin-top:119px;color:#A7A7A7;font-size:12px;'>服务承诺</span>
            <span style='float:left;margin-left:-343px;margin-top:119px;color:#666666;font-size:12px;'>
                赠送保险
            </span>
            <span style='float:left;margin-left:-278px;margin-top:119px;color:#666666;font-size:12px;'>
                破损包退
            </span>
            <span style='float:left;margin-left:-214px;margin-top:119px;color:#666666;font-size:12px;'>
                正品保证
            </span>
            <span style='float:left;margin-left:-149px;margin-top:119px;color:#666666;font-size:12px;'>
                极速退款
            </span>
            <span style='float:left;margin-left:-81px;margin-top:119px;color:#666666;font-size:12px;'>
                赠运费险
            </span>
            <span style='float:left;margin-left:-14px;margin-top:119px;color:#666666;font-size:12px;'>
                七天无理由退换
            </span>
        </div>
        <div>
            <span style='float:left;margin-left:5px;margin-top:27px;color:#999;font-size:12px;'>检测到您当前处于非安全网络环境，部分商品信息可能不准确，请在交易支付页面再次确认商品价格信息。</span>
        </div>
