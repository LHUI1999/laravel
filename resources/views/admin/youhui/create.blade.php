...
<div class="box span12" style="">
	...
	<div class="box-content">
		<form class="form-horizontal" action="/admin/youhui" method='post'>
			{{ csrf_field() }}
			<fieldset>
				<!--  -->
			  <div class="control-group">
				<label class="control-label" for="focusedInput"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">优惠券抵扣价格</font></font></label>
				<div class="controls">
				  <input class="input-xlarge focused" id="focusedInput" type="text" value="" name="dikou">
				</div>
			  </div>
			 ...
			 <div class="control-group">
				...
				<div class="controls">
				  <select name='yname' id="selectError3">
					<option value="0">
                    ...
                    <option {{$v->id==$id?'selected' : ''}} value="{{$v->id}}" {{substr_count($v->path,',') >=2 ? 'disabled' : ''}} >
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">{{$v->cname}}</font>
                        </font>
                    </option>
					@endforeach --}}
