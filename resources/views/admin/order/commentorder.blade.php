...
<div class="row-fluid sortable ui-sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title="">
				<h2><i class="halflings-icon white user"></i><span class="break"></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">待评价</font></font></h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form action="/admin/order/commentorder" method="get">
					关键字
				  ...
				  <thead>
			  		...
			  		<tbody role="alert" aria-live="polite" aria-relevant="all">
				  		...
				  		<tr class="odd">
							...
							<td class="center ">
								<a class="btn btn-info" href="/admin/order/commentinfo?id={{$v->id}}">
									查看详情
								</a>
								{{-- <a class="btn btn-success" href="/admin/order/comment?id={{$v->id}}">
									提醒评价
								</a> --}}
								<!--  -->
